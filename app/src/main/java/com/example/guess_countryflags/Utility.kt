...
//read and extract data from the country.json file
fun getCountriesFromAssets(context: Context): Map<String, String> {
...
//get the flag image for a given country code
